...
<body>
    ...
    <div class="container mt-4">
        <h2>Formulir Pendaftaran guru SMK Negeri 1 Lagos</h2><br>
        <form action="proses-pendaftaran.php" method="POST">
            ...
            <div class="mb-3">
                <label for="nama" class="form-label">nomor telpon </label>
                <input type="number" class="form-control" name="number" placeholder="nomor aktif" />
            </div>
            <div class="mb-3">
